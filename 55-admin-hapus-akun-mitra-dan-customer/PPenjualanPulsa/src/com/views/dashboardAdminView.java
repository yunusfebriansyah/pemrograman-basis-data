...
private cBigFont valueJmlRequestSaldoBeranda = new cBigFont("0", 495, 320);
    ...
    btnHapusDataMitra.addActionListener(new ActionListener(){
      ...
      public void actionPerformed ( java.awt.event.ActionEvent ae)
      {
        ...
        if( selectedIndex != -1 )
        {
          ...
          int idMitra = Integer.valueOf( tblDataDataMitra.getValueAt(selectedIndex, 1).toString() );

          if( Model.hapusMitra( idMitra ) ){
            JOptionPane.showMessageDialog(dashboardAdminView.this, "Data Mitra berhasil dihapus!", "Berhasil", JOptionPane.INFORMATION_MESSAGE);
            initsDataMitra();
          }else{
            JOptionPane.showMessageDialog(dashboardAdminView.this, "Data Mitra gagal dihapus!", "Gagal", JOptionPane.ERROR_MESSAGE);
          }
        }else{
  ...
  private void initsDataCustomer()
  {
    ...
    btnHapusDataCustomer.addActionListener( new ActionListener(){
      ...
      public void actionPerformed( java.awt.event.ActionEvent ae)
      {
        ...
        {
          // kalo ada yang dipilih
          int idCustomer = Integer.valueOf( tblDataDataCustomer.getValueAt(selectedIndex, 1).toString() );

          if( Model.hapusCustomer( idCustomer ) ){
            JOptionPane.showMessageDialog(dashboardAdminView.this, "Data Customer berhasil dihapus!", "Berhasil", JOptionPane.INFORMATION_MESSAGE);
            initsDataCustomer();
          }else{
            JOptionPane.showMessageDialog(dashboardAdminView.this, "Data Customer gagal dihapus!", "Gagal", JOptionPane.ERROR_MESSAGE);
          }
        }else{
          // kalo gak ada yang diseleksi
          JOptionPane.showMessageDialog(dashboardAdminView.this, "Pilih data terlebih dahulu!", "Peringatan", JOptionPane.WARNING_MESSAGE);
    ...
    btnUbahDataPaket.addActionListener(new ActionListener(){
      ...
      public void actionPerformed(java.awt.event.ActionEvent ae)
      {
        ...
        if( selectedIndex == -1 ){
          ...
          JOptionPane.showMessageDialog(dashboardAdminView.this, "Pilih data paket yang akan diubah terlebih dahulu!", "Peringatan", JOptionPane.WARNING_MESSAGE);
        }else{
          int idPaket = Integer.valueOf( tblDataDataPaket.getValueAt(selectedIndex, 0).toString() );
    ...
    btnUbahPaketUbahDataPaket.addActionListener( new ActionListener(){
      ...
      public void actionPerformed( java.awt.event.ActionEvent ae )
      {
        ...
        if( txtNamaPaketUbahDataPaket.getText().trim().isEmpty() || txtKuotaPaketUbahDataPaket.getText().trim().isEmpty() || txtHargaPaketUbahDataPaket.getText().trim().isEmpty() || txtDeskripsiPaketUbahDataPaket.getText().trim().isEmpty() ){
          ...
          // spesifik ke kuota
          if( txtKuotaPaketUbahDataPaket.getText().trim().isEmpty() ) content.add(errorKuotaPaketUbahDataPaket); else content.remove(errorKuotaPaketUbahDataPaket);
          
          // spesifik ke Harga
          if( txtHargaPaketUbahDataPaket.getText().trim().isEmpty() ) content.add(errorHargaPaketUbahDataPaket); else content.remove(errorHargaPaketUbahDataPaket);
          
          // spesifik ke Deskripsi
          if( txtDeskripsiPaketUbahDataPaket.getText().trim().isEmpty() ) content.add(errorDeskripsiPaketUbahDataPaket); else content.remove(errorDeskripsiPaketUbahDataPaket);
          ...
          if( Model.ubahDataPaket(idPaket, nama, deskripsi, kuota, harga, statusAktif) ){
            // kalau berhasil
            JOptionPane.showMessageDialog(dashboardAdminView.this, "Berhasil ubah data paket.", "Berhasil", JOptionPane.INFORMATION_MESSAGE);
            initsDataPaket();
          }else{
            // kalau tidak berhasil
            JOptionPane.showMessageDialog(dashboardAdminView.this, "Gagal ubah data paket.", "Gagal", JOptionPane.ERROR_MESSAGE);
          }
  ...
  private void initsCalonMitra()
  {
    ...
    btnApproveCalonMitra.addActionListener( new ActionListener(){
      ...
      public void actionPerformed( java.awt.event.ActionEvent ae)
      {
        int selectedIndex = Integer.valueOf(tblDataCalonMitra.getSelectedRow());
        ...
        if( selectedIndex == -1){
          ...
          // kalo ada yan dipilih
          int idMitra = Integer.valueOf( tblDataCalonMitra.getValueAt(selectedIndex, 0).toString() );
