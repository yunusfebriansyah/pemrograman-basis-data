...
public class Model {
  ...
  public static Object[] getDetailCustomerByNoHp( String noHp )
  {
    ...
    try {
      ...
      // query select
      String query = "SELECT * FROM vwcustomer WHERE nomorHpCustomer = " + noHp;
  ...
  public static boolean tambahDataTransaksiPulsa(int idCustomer, int jumlahPulsa )
  {
    ...
    try {
      ...
      // query select
      String query = "INSERT INTO tbltransaksipulsa VALUES (" + null + ", " + idCustomer + ", " + jumlahPulsa + ", 3, NOW(), 'diproses', '1')";
  ...
  public static boolean ubahProfilCustomer(int idCustomer, String namaCustomer, String emailCustomer )
  {
    boolean data = false;
  ...
  public static boolean requestSaldoMitra( int idMitra )
  {
    ...
    try {
      ...
      // query select
      String query = "INSERT INTO tbltransaksisaldo VALUES (" + null + ", " + idMitra + ", 250000, NOW(), 'diproses', '1')";
  ...
  // method beli paket
  public static boolean beliPaket( int idCustomer, int idPaket )
  {
    boolean data = false;
  ...
  public static boolean ubahSaldoMitraByRequestSaldo( int idMitra )
  {
    ...
    try {
      ...
      // query select
      String query = "UPDATE tblsaldomitra SET saldoMitra = saldoMitra + 250000 WHERE idMitra = " + idMitra;
  ...
  try {
    ...
    // query select
    String query = "UPDATE tblsaldomitra SET saldoMitra = 150000 WHERE idMitra = " + idMitra;
  ...
  try {
    ...
    // query select
    String query = "INSERT INTO tblcustomer VALUES (NULL, '" + nama + "', '" + noHp + "', '" + password + "', '', '1')";
